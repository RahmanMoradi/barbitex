...
namespace App\Http\Controllers\Api\V1\Airdrop;
...
class AirdropController extends Controller
{
    ...
    {
        $articles = Article::query()->where('airdrop', 1)->orderByDesc('created_at');
        ...
        $data = $list['data'];
        $meta = $list['meta'];
        return $this->response(1, $data, $meta, Lang::get('airdrops content'));
    }
}
