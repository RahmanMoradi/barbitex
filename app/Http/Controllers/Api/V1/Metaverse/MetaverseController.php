...
namespace App\Http\Controllers\Api\V1\Metaverse;
...
class MetaverseController extends Controller
{
    ...
    {
        $articles = Article::query()->where('metaverse', 1)->orderByDesc('created_at');
        ...
        $data = $list['data'];
        $meta = $list['meta'];
        return $this->response(1, $data, $meta, Lang::get('metaverses content'));
    }
}
