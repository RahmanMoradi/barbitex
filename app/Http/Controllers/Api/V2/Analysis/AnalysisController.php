...
namespace App\Http\Controllers\Api\V2\Analysis;
...
class AnalysisController extends Controller
{
    ...
    {
        $articles = Article::query()->where('analysis', 1)->orderByDesc('created_at');
        ...
        $data = $list['data'];
        $meta = $list['meta'];
        return $this->response(1, $data, $meta, Lang::get('analysis content'));
    }
}
