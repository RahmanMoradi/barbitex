...
namespace App\Http\Controllers\Api\V2\Reward;
...
class RewardController extends Controller
{
    ...
    {
        $articles = Article::query()->where('reward', 1)->orderByDesc('created_at');
        ...
        $data = $list['data'];
        $meta = $list['meta'];
        return $this->response(1, $data, $meta, Lang::get('rewards content'));
    }
}
