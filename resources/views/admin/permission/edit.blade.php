...
@section('title', trans('edit permission'))
                                    ...
                                    <div class="col-8 mx-auto">
                                        <div class="form-group">
                                            ...
                                            <input name="name" type="text" class="form-control"
                                                   id="name" value="{{old('name') ? old('name') : $permission->name}}"
                                                   placeholder="@lang('example') : show-ticket">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input name="label" type="text" class="form-control"
                                                   ...
                                                   placeholder="@lang('example') : @lang('view tickets')">
                                        </div>
                                    </div>
                                </div>
                            </div>
