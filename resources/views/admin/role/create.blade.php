...
@section('title', trans('add a role'))
                                    ...
                                    <div class="col-8 mx-auto">
                                        <div class="form-group">
                                            ...
                                            <input name="name" type="text" class="form-control"
                                                   ...
                                                   placeholder="@lang('example') : super_admin">
                                        </div>
                                        <div class="form-group">
                                            <label for="label">@lang('role description')</label>
                                            <input name="label" type="text" class="form-control"
                                                   id="label" value="{{old('label')}}"
                                                   placeholder="@lang('example') : @lang('super admin')">
                                        </div>

                                        <div class="form-group">
                                            <label for="icon">@lang('permissions')</label>
                                            <select class="form-control" name="permission_id[]"
                                                    title="@lang('select')" multiple>
                                                @foreach($permissions as $permission)
                                                    <option value="{{$permission->id}}">{{$permission->label}}
