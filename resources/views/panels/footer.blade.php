            ...
            <footer class="footer {{ $configData['footerType'] }} footer-light">
                ...
                <p class="clearfix blue-grey lighten-2 mb-0"><span
                        class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; {{date('Y')}}<a
                            ...
                            target="_blank">{{Setting::get('title')}},</a>All rights Reserved</span>
                    <span
                        class="float-md-right d-none d-md-block">Designed By
                        <a
                            href="https://webazin.net">Webazin.net</a> & Made with<i
